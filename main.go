...
func (engine *Engine) NoRoute(prefix string, handler HandlerFunc) {
	engine.noRoutes = append(engine.noRoutes, struct {
		prefix  string
		handler HandlerFunc
	}{
		prefix:  prefix,
...
func (engine *Engine) NoRouteAny(handler HandlerFunc) {
